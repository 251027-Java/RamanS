...
public class Main {
    public static void main (String[] args) {
        ...
        Scanner scanner = new Scanner(System.in);
            // first input is the number of ISBNs
        ...
        // use a iterated/for loop to search through the list of ISBNs
        for (int i = 0; i < N; i++) {
        ...
        for (int i = 0; i < N; i++) {
            // is the current target_ISBN less than the current list_ISBN?
